import { ShakaContactOrigin } from "@shaka-web-features/contact/ShakaContactOrigin";
...
const ShakaPagesContact: NextPage = () => {
  ...
  return mounted ? (
    <ShakaContactOrigin basis={{ key: RootShape.basiskey, dictionary }} />
  ) : null;
};

export default ShakaPagesContact;
